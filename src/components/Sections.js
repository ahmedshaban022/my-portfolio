      ...
      <section className="home  py-5" id="home" data-aos="fade-down">
        <div className="container-lg">
          <div className="row min-vh-100 align-items-center align-content-center">
            {/* <div className="col-md-4 mt-5 mt-md-0"><Ramadan /> </div> */}
            <div className="col-md-6 mt-5 mt-md-0">
              <div className="home-img">
                <img
                  style={{ width: "400px" }}
                  className="rounded-circle mw-100 mh-50"
                  src={require("../imgs/Ahmed Shaban.PNG")}
                  alt="Profile image"
                />
              </div>
            </div>
        ...
        <div className="container-lg py-4">
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="about-text">
                <h3 className="fs-4 mb-3">Work Experience</h3>
                <p className="text-muted">
                  Full Stack Developer Using MERN At AutoService , Kuwait
                  (Remote)
                  <br />
              ...
              <div className="row">
                <div className="col-lg-12 d-flex align-items-center">
                  ...
                  <div className="social-links fs-4 ">
                    <a
                      href="https://www.facebook.com/assassin2022/"
                      target="_blank"
                      className="text-dark me-2 "
                    >
                      <i className="fab fa-facebook text-primary" />
                    </a>
                    <a href="#" target="_blank" className="text-dark me-2">
                    ...
                    <a
                      href="https://www.linkedin.com/in/ahmed-shaban-1756b5227/"
                      target="_blank"
                      className="text-dark me-2 "
                    >
      ...
      <section className="services py-5" id="services">
        <div className="container-lg py-4">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="section-title text-center">
                <h2 className="fw-bold mb-5" data-aos="flip-down">
                  What I Do
                </h2>
              </div>
            </div>
          ...
          <div className="row text-center">
            <div className="col-md-12 col-lg-6 mb-4" data-aos="fade-right">
              <div className="service-item shadow-sm p-4 rounded bg-white">
                ...
                <p className="text-muted">
                  Building Web Applications with high quality , performance and
                  security
                </p>
              </div>
            </div>
            <div className="col-md-12 col-lg-6 mb-4" data-aos="fade-left">
              <div className="service-item shadow-sm p-4 rounded bg-white">
                ...
                <p className="text-muted">
                  You will get the right design for you and the possibility of
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up-right">
                <img
                  ...
                  src={require("../projects/Ua-Shop.png")}
                  alt="portfolio image"
                />
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up-right">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/souq-abnoud.jpg")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">
                  Souq Abnoud (MERN)
                ...
                <p className="mb-4">
                  <a
                    href="https://ahmedshaban022.github.io/souq-abnoud/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/trans.PNG")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">
                  {" "}
                ...
                <p className="mb-4">
                  <a
                    href="https://booking-admin-dashboard.netlify.app/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up-left">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/UA-Todo.PNG")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">Todo (MERN)</h3>
                <p className="mb-4">
                  <a
                    href="https://ua-todo.herokuapp.com/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up-right">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/pte-admin.PNG")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">
                  PTE-Admin Dashboard (React)
                </h3>
                <p className="mb-4">
                  <a
                    href="https://ahmedshaban022.github.io/pte-task-admin-panel/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/Yello.png")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">
                  Yello-Posts (MERN)
                ...
                <p className="mb-4">
                  <a
                    href="http://yello-task.herokuapp.com/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
            ...
            <div className="col-md-6 col-lg-4">
              <div className="portfolio-item" data-aos="fade-up-left">
                <img
                  className="w-100 img-thumbnail"
                  src={require("../projects/5.PNG")}
                  alt="portfolio image"
                />
                <h3 className="text-capitalize fs-5 my-2">Javascript Games</h3>
                <p className="mb-4">
                  <a
                    href="https://ahmedshaban022.github.io/JS-Games/"
                    target="_blank"
                    className="text-danger text-decoration-none"
                  >
                    Live Demo
